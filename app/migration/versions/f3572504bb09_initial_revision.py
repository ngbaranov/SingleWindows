...
def upgrade() -> None:
    ...
    sa.Column('name', sa.Enum('Management', 'Administrative', 'Accounting', 'Metrology', 'Passes', 'Dispatcher', 'Medical', 'Commercial', 'Moscow', 'Mehanical', 'Power', 'IT', 'HR', 'Logistics', 'Safety', 'OTK', 'Builders', 'Secrecy', 'Technical', 'Repair', 'Composition', 'Security', 'Quality', 'Financial', 'Legal', 'Trade', 'Cafe', 'Transport', 'Power_suple', 'Workshop', 'First_section', 'Precious_metals', 'Gold', 'Silver', 'Platinum', 'Rhodium', 'Recycling', 'laboratory', 'Cleaning', 'General', 'outside', name='departments'), nullable=False),
